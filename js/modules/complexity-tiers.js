...
export const EXERCISE_COMPLEXITY = {
  ...
  'Leg Adduction': COMPLEXITY_TIERS.SIMPLE,
  ...
  'Reverse Crunch': COMPLEXITY_TIERS.SIMPLE,
  'Pallof Press': COMPLEXITY_TIERS.SIMPLE,
  'Machine Fly': COMPLEXITY_TIERS.SIMPLE,
  'Landmine Press': COMPLEXITY_TIERS.MODERATE,
  ...
  'Standard DB Curls': COMPLEXITY_TIERS.SIMPLE,
  'DB Hammer Curls': COMPLEXITY_TIERS.SIMPLE,
  'Overhead Cable Triceps Extension': COMPLEXITY_TIERS.SIMPLE,
  'Cable Triceps Pushdown': COMPLEXITY_TIERS.SIMPLE,
  'Overhead Tricep Extension': COMPLEXITY_TIERS.SIMPLE,
  'Tricep Pushdowns': COMPLEXITY_TIERS.SIMPLE,
  'KB Goblet Squat': COMPLEXITY_TIERS.SIMPLE,

  // Pathway exercises: machine / cable / bodyweight basics (avoid default SIMPLE auto-unlock for unnamed pathway picks)
  'Assisted Lat Pulldown': COMPLEXITY_TIERS.SIMPLE,
  'Band Face Pulls': COMPLEXITY_TIERS.SIMPLE,
  'Band Pallof Press': COMPLEXITY_TIERS.SIMPLE,
  'Bodyweight Hip Thrust': COMPLEXITY_TIERS.SIMPLE,
  'Bodyweight Side-lying Abduction': COMPLEXITY_TIERS.SIMPLE,
  'Bodyweight Side-lying Adduction': COMPLEXITY_TIERS.SIMPLE,
  'Bodyweight Squats': COMPLEXITY_TIERS.SIMPLE,
  'Cable Chest Press': COMPLEXITY_TIERS.SIMPLE,
  'Cable Crunch': COMPLEXITY_TIERS.SIMPLE,
  'Cable Fly': COMPLEXITY_TIERS.SIMPLE,
  'Cable Overhead Extension': COMPLEXITY_TIERS.SIMPLE,
  'Cable Reverse Fly': COMPLEXITY_TIERS.SIMPLE,
  'Clamshells': COMPLEXITY_TIERS.SIMPLE,
  'Decline Reverse Crunch': COMPLEXITY_TIERS.SIMPLE,
  'Extended Dead Bug': COMPLEXITY_TIERS.SIMPLE,
  'Fire Hydrants': COMPLEXITY_TIERS.SIMPLE,
  'Glute Bridges': COMPLEXITY_TIERS.SIMPLE,
  'Incline DB Curls': COMPLEXITY_TIERS.SIMPLE,
  'Knee Tucks': COMPLEXITY_TIERS.SIMPLE,
  'Light Cable Pallof Press': COMPLEXITY_TIERS.SIMPLE,
  'Light Machine Fly': COMPLEXITY_TIERS.SIMPLE,
  'Light Tricep Pushdowns': COMPLEXITY_TIERS.SIMPLE,
  'Lying Knee Raise': COMPLEXITY_TIERS.SIMPLE,
  'Machine calf raise': COMPLEXITY_TIERS.SIMPLE,
  'Machine Chest Fly': COMPLEXITY_TIERS.SIMPLE,
  'Machine Curls': COMPLEXITY_TIERS.SIMPLE,
  'Machine Incline Press': COMPLEXITY_TIERS.SIMPLE,
  'Machine Row': COMPLEXITY_TIERS.SIMPLE,
  'Pallof Press with Hold': COMPLEXITY_TIERS.SIMPLE,
  'Seated DB Lateral Raises': COMPLEXITY_TIERS.SIMPLE,
  'Single-Leg Dead Bug': COMPLEXITY_TIERS.SIMPLE,
  'Single-leg Calf Raise': COMPLEXITY_TIERS.SIMPLE,
  'Single-leg Curl': COMPLEXITY_TIERS.SIMPLE,
  'Single-leg Seated Calf': COMPLEXITY_TIERS.SIMPLE,
  'Slow Dead Bug': COMPLEXITY_TIERS.SIMPLE,
  'Tall-Kneeling Pallof Press': COMPLEXITY_TIERS.SIMPLE,
  'Weighted Cable Abduction': COMPLEXITY_TIERS.SIMPLE,
  'Weighted Cable Adduction': COMPLEXITY_TIERS.SIMPLE,
  'Weighted Dead Bug': COMPLEXITY_TIERS.SIMPLE,
  'Weighted Leg Extension': COMPLEXITY_TIERS.SIMPLE,

  // MODERATE tier (62 exercises: multi-joint OR unstable base OR multi-plane)
  'DB Flat Bench Press': COMPLEXITY_TIERS.MODERATE,
  'Decline DB Press': COMPLEXITY_TIERS.MODERATE,
  ...
  'Bent-Over Reverse Fly': COMPLEXITY_TIERS.MODERATE,
  'Barbell Curls': COMPLEXITY_TIERS.MODERATE,
  'Cable Press': COMPLEXITY_TIERS.MODERATE,
  'Cable Woodchop': COMPLEXITY_TIERS.MODERATE,
  'Copenhagen Plank (modified)': COMPLEXITY_TIERS.MODERATE,
  'DB Single-Arm Row': COMPLEXITY_TIERS.MODERATE,
  'Dips (machine-assisted)': COMPLEXITY_TIERS.MODERATE,
  'EZ Bar Curls': COMPLEXITY_TIERS.MODERATE,
  'Goblet Squat': COMPLEXITY_TIERS.MODERATE,
  'Good Mornings': COMPLEXITY_TIERS.MODERATE,
  'Hanging Knee Raise': COMPLEXITY_TIERS.MODERATE,
  'Heavy Landmine Press': COMPLEXITY_TIERS.MODERATE,
  'Light Landmine Press': COMPLEXITY_TIERS.MODERATE,
  'Nordic Curls': COMPLEXITY_TIERS.MODERATE,
  'Nordic Curls (assisted)': COMPLEXITY_TIERS.MODERATE,
  'Seal Row': COMPLEXITY_TIERS.MODERATE,
  'Single-Arm Landmine Press': COMPLEXITY_TIERS.MODERATE,
  'Single-leg Hip Thrust': COMPLEXITY_TIERS.MODERATE,
  'Single-leg Press': COMPLEXITY_TIERS.MODERATE,
  'Single-leg RDL': COMPLEXITY_TIERS.MODERATE,
  'Sissy Squats': COMPLEXITY_TIERS.MODERATE,
  'Sliding Leg Curl': COMPLEXITY_TIERS.MODERATE,
  'Upright Rows': COMPLEXITY_TIERS.MODERATE,
  'Weighted Hip Thrust': COMPLEXITY_TIERS.MODERATE,
  ...
  'Archer Pull-ups': COMPLEXITY_TIERS.COMPLEX,
  'Band-Assisted Pull-ups': COMPLEXITY_TIERS.COMPLEX,
  'Barbell Incline Press': COMPLEXITY_TIERS.COMPLEX,
  'Barbell RDL': COMPLEXITY_TIERS.COMPLEX,
  'Conventional Deadlift': COMPLEXITY_TIERS.COMPLEX,
  'Front Squat': COMPLEXITY_TIERS.COMPLEX,
  'Pull-ups': COMPLEXITY_TIERS.COMPLEX,
  'Weighted Pull-ups': COMPLEXITY_TIERS.COMPLEX,
